...
count = len(oss.listdir("S:\\Sign\\AtoZ_3.1\\"))
c_dir = 'A'
...
cv2.imwrite("S:\\Sign\\white.jpg\\",white)
...
while True:
    try:
        ...
        white = cv2.imread("S:\\Sign\\white.jpg\\")
        ...
        if interrupt & 0xFF == ord('n'):
            ...
            if ord(c_dir)==ord('Z')+1:
                c_dir='A'
            flag = False
            count = len(oss.listdir("S:\\Sign\\AtoZ_3.1\\" + (c_dir) + "\\"))
        ...
        if flag==True:
            ...
            if suv==180:
                flag=False
            if step%3==0:
                cv2.imwrite("S:\\Sign\\AtoZ_3.1\\" + (c_dir) + "\\" + str(count) + ".jpg",
                            skeleton1)
